          ...
          <div className="container text-center text-md-start mt-5">
            <div className="row mt-3">
              <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                ...
                />
                <p>
                  Welcome to DomiYYC! Our mission is to provide the best
                  services for you to discover and experience our great city.
              ...
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                />
                <p>
                  <i className="fas fa-home mr-3"></i> Calgary, Alberta, Canada
                </p>
                <p>
                  <i className="fas fa-envelope mr-3"></i> info@domiyyc.ca
                </p>
                <p>
                  <i className="fas fa-phone mr-3"></i> +1 403 000 0000
                </p>
                <p>
                  <i className="fas fa-print mr-3"></i> +1 403 000 0001
                </p>
              </div>
            </div>
          </div>
